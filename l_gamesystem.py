...
DISCORD_TOKEN     = os.environ["L_TOKEN"]
ANTHROPIC_API_KEY = os.environ["ANTHROPIC_API_KEY"]
TARGET_CHANNEL_ID = int(os.environ["L_CHANNEL_ID"])
MAX_HISTORY       = 40
SYSTEM_PROMPT     = "You are L, a game systems developer. Analyze game design documents, system specs, balance sheets, UI designs, and any files with deep expertise in mechanics and systems. Always give specific, actionable feedback. Respond in Korean unless asked otherwise."
